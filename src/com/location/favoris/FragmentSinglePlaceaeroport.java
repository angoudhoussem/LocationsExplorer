...
import com.example.locationsexplorer.R.drawable;
import com.example.locationsexplorer.R.id;
 ...
 */
public class FragmentSinglePlaceaeroport extends Fragment {
	String cmp;
	...
	class taskLis1t extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... args) {
			...
			HttpConnectionParams.setConnectionTimeout(httpParams, 100000);
			HttpConnectionParams.setSoTimeout(httpParams, 100000);
			String urll = "entity.favoris/favorisAeroport/"
	...
	class taskTOP extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... args) {
			...
			HttpConnectionParams.setConnectionTimeout(httpParams, 100000);
			HttpConnectionParams.setSoTimeout(httpParams, 100000);
			String urll = "entity.top/topaeroport/" + ConstantValues.Email
					+ "/" + id + "/" + id1;
